 ...
 * flow rule strings into structured data. The library provides functions
 * to parse attributes, patterns, and actions separately, which is useful
 * when building flow rules programmatically from user input.
 *
