...
static struct rte_flow_parser_vxlan_encap_conf testpmd_vxlan_conf;
static struct rte_flow_parser_nvgre_encap_conf testpmd_nvgre_conf;
static struct rte_flow_parser_l2_encap_conf testpmd_l2_encap_conf;
static struct rte_flow_parser_l2_decap_conf testpmd_l2_decap_conf;
static struct rte_flow_parser_mplsogre_encap_conf testpmd_mplsogre_encap_conf;
static struct rte_flow_parser_mplsogre_decap_conf testpmd_mplsogre_decap_conf;
static struct rte_flow_parser_mplsoudp_encap_conf testpmd_mplsoudp_encap_conf;
static struct rte_flow_parser_mplsoudp_decap_conf testpmd_mplsoudp_decap_conf;
static struct rte_flow_action_conntrack testpmd_conntrack;
