...
Signed-off-by: John Smith <john at example.com>
```
...
Signed-off-by: Jane Doe <jane at example.com>
```
...
**Tag format**: `Tag-name: Full Name <email at domain.com>`
...
- [ ] `Cc: stable at dpdk.org` for stable backport candidates
...
- Missing Cc: stable at dpdk.org for fixes
- Documentation gaps
