 ...
 * this header or in rte_flow_parser_cmdline.h may be called concurrently,
 * even with different port IDs. All calls must be serialized by the
 * application (e.g., by confining all parser usage to a single thread).
 */
